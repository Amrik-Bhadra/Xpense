...
export default async function DashboardPage() {
  ...
  const maxExpense = Math.max(
    ...expenseTotals.map((t) => t._sum.amount ?? 0),
    1,
  );
    ...
    <div className="px-10 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <div className="rounded-2xl bg-surface border border-border p-5">
          ...
          <p
            className={`font-tabular text-2xl font-semibold tracking-tight ${netBalance >= 0 ? "text-positive" : "text-negative"}`}
          >
            {netBalance >= 0 ? "₹" : "-₹"}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1.5">
                        ...
                        <span className="font-tabular text-sm font-semibold text-positive">
                          +₹{amount.toFixed(2)}
                        </span>
                      </div>
        ...
        {expenseTotals.length > 0 && (
          <div>
            <p className="text-xs font-medium text-negative mb-2 px-1">
              EXPENSE
            </p>
            <div className="rounded-2xl bg-surface border border-border divide-y divide-border">
              {expenseTotals.map((t) => {
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1.5">
                        ...
                        <span className="font-tabular text-sm font-semibold text-negative">
                          -₹{amount.toFixed(2)}
                        </span>
                      </div>
                      <div className="h-1.5 rounded-full bg-surface-hover overflow-hidden">
